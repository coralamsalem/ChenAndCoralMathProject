...
public class StudentRegisterPageController {
    ...
    public StudentRegisterPageController()
    {
        ...
        RegisterBtn.addActionListener(new StudentRegisterPageController.registerListener());

        f = new File("C:\\Users\\Moran\\IdeaProjects\\Student.txt");
